...
class GanttChart extends React.Component {
  ...
  createBarChart() {
    var tasks = [
      ...
      {"startDate":new Date("Sun Dec 09 06:29:53 EST 2012"),"endDate":new Date("Sun Dec 09 06:34:04 EST 2012"),"taskName":"D Job","percentComplete":0.0,"dependencies":["P Job"]}      
    ];
    ...
    var ganttChart = gantt(this.node).tickFormat(format);
    ganttChart(tasks);
  }
  render(){
    return (
